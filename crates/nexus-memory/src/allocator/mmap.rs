    ...
    if #[cfg(unix)] {
        ...
        mod windows_impl {
            ...
            use windows::Win32::System::Memory::{
                ...
                FILE_MAP_ALL_ACCESS, PAGE_READWRITE, PAGE_READONLY,
            };
            use windows::Win32::Foundation::INVALID_HANDLE_VALUE;

            pub(super) fn alloc(size: usize, name: &'static str) -> Result<(*mut u8, windows::Win32::Foundation::HANDLE), MmapError> {
                todo!()
            }
            ...
            pub(super) unsafe fn free(ptr: *mut u8, size: usize, handle: windows::Win32::Foundation::HANDLE, name: &'static str) {
                todo!()
            }
        }
    }
...
mod tests {
    ...
    /// Allocate, seal, attempt write via write_volatile, verify fault is caught.
    /// Uses std::panic::catch_unwind + signal handler (Unix) or
